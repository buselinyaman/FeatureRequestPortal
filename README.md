...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 27e25112-d53a-42a7-b2d3-574459923493
```

> `27e25112-d53a-42a7-b2d3-574459923493` is the password of the certificate, you can change it to any password you want.
...
* `FeatureRequestPortal.Application.Tests`: Application layer tests.
* `FeatureRequestPortal.Domain.Tests`: Domain layer tests.
* `FeatureRequestPortal.EntityFrameworkCore.Tests`: Entity Framework Core integration tests.
